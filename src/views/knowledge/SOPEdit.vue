...
const handleSave = async () => {
  try {
    ...
    // 這裡應該調用API更新SOP
    // await knowledgeStore.updateSOP(route.params.id, form)
    
    message.success('SOP 更新成功')
...
onMounted(async () => {
  ...
  try {
    ...
    // 載入SOP數據
    // const sop = await knowledgeStore.fetchSOP(route.params.id)
    // Object.assign(form, sop)
  } catch (error) {
